      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <Link
              href="/contact"
              className="bg-black hover:bg-transparent transition-colors hover:border-2 border-black border-2 hover:text-black text-white px-6 py-3 rounded-full font-bold relative overflow-hidden group flex items-center justify-center"
            >
