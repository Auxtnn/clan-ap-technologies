    ...
    <section ref={sectionRef} className="py-20 bg-gray-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          >
            Don't take our word for it – hear from the companies we've helped deliver exceptional software.
          </motion.p>
        </div>
                      ...
                      <div className="w-12 h-12 rounded-full bg-gray-200 relative overflow-hidden">
                        {testimonials[currentIndex].image ? (
                          ...
                          <div className="absolute inset-0 flex items-center justify-center text-gray-400">
                            <span className="text-lg font-bold">{testimonials[currentIndex].author[0]}</span>
                          </div>
                        )}
                      </div>
                    ...
                    <div className="w-48 h-24 relative">
                      {testimonials[currentIndex].logo ? (
                        ...
                        <div className="absolute inset-0 flex items-center justify-center text-gray-400 border border-gray-200 rounded p-4">
                          <span className="text-lg font-bold">{testimonials[currentIndex].company}</span>
                        </div>
                      )}
                    </div>
                  </div>
          ...
          <div className="flex justify-center mt-8 space-x-2">
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 rounded-full transition-all duration-300 ${index === currentIndex ? 'bg-yellow-500 w-6' : 'bg-gray-300'}`}
...
const testimonials = [
  {
    ...
    quote: "Manpreet from ClanAP Technologies played a crucial role as a Quality Assurance Specialist at Dashy Dash, showcasing exceptional precision and professionalism. His meticulous testing and attention to detail significantly reduced defects, enhancing the efficiency and quality of software delivery."
  },
  {
  ...
  },
  {
    ...
    quote: "Manpreet from ClanAP Technologies has worked as a freelancer for our company on a project for my department. His task was the development of automated E2E testing in Cypress. I highly recommend Manpreet as he is very easy to work with and produces great results. He writes excellent code that is easy to understand and maintain for later use."
  },
  {
    author: "Fred Tzeng",
    role: "CTO",
