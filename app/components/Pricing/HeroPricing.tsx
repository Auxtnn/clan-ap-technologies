      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            Quality That Fits
            <br />
            <span className="text-yellow-500">Your Budget.</span>
          </motion.h1>
          ...
          >
            Choose from our flexible QA service packages, each engineered to
            deliver measurable quality improvements, faster release cycles, and
            fewer production incidents for your team.
          </motion.p>
