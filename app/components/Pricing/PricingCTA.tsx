    ...
    <section ref={sectionRef} className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            Not Sure Which Plan{" "}
            <span className="text-yellow-500">Is Right for You?</span>
          </motion.h2>
          ...
          >
            Book a free 30-minute strategy call with our team. We&apos;ll assess
            your current QA maturity, understand your release goals, and
            recommend exactly the right package for your situation, no pressure,
            no sales pitch.
          </motion.p>
