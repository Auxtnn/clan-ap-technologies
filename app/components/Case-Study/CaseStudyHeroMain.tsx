    ...
    <section className="pt-32 md:pb-16 pb-4 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            Explore how our comprehensive QA strategies have transformed
            businesses across industries. These case studies showcase our proven
            methodology and measurable results in real-world applications
          </motion.p>
        </div>
      </div>
    </section>
...
export default CaseStudyHeroMain;
