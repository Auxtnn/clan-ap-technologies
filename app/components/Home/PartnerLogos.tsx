...
const PartnerLogos = () => {
  ...
  const partners: Partner[] = [
    ...
    { name: "Wayleader", path: "/images/partners/wayleader.png" },
    { name: "Scaura", path: "/images/partners/scaura.png" },
    { name: "Talleflow", path: "/images/partners/talleflow.png" },
    ...
    { name: "Element", path: "/images/partners/element.png" },
  ];
  ...
  return (
    <div className="pb-12 mt-6 border-gray-100">
